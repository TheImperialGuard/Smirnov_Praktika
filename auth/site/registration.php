        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" style="margin-top: 90px;width: 883px;margin-left: 191px;" method="post">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="user_name" value="<?php echo @$data['user_name']; ?>" style="width: 253px;"></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Фамилия</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="user_surname" value="<?php echo @$data['user_surname']; ?>" style="width: 253px;"></div>
                </div>
                <div class="form-row form-group">
