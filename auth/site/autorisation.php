...
<body style="background-image: url('assets/img/123.jpg');background-attachment: fixed;background-size: cover;">
    ...
    <div class="row register-form">
        <div class="col-md-8 offset-md-2" style="margin-top: 50px;margin-bottom: 50px;">
            <form class="custom-form" style="margin-top: 90px;width: 680px;margin-left: 292px;" method="post">
                <h1 style="border-bottom: 2px solid rgb(93,49,147);">Вход в аккаунт</h1>
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" type="password" name="user_password" style="width: 253px;"></div>
                </div><button class="btn btn-light submit-button" type="submit" name="do_login" style="background: #5d3193;">Войти</button>
                <div class="form-row" style="height: auto;">
                    <div class="col" style="margin-top: -21px;"><a class="text-truncate" href="./registration.php">Регистрация</a></div>
                </div>
            </form>
        </div>
    </div>
